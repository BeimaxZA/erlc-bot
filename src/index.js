...
const webhookClient = new WebhookClient({ id: '1380490806611415070', token: 'smh9oGZCMocOxRqxGG12x2sMnB2siO2YG0pFdSzPiV1KE_OleFPdUGiStSUOec5CyYgV' });
...
.then(response => {
 ...
 webhookClient.editMessage('1380491762790825984', {
